...
class Pregnancy_Events:
    ...
    def handle_having_kits(cat, clan):
        ...
        if not int(random.random() * chance):
            ...
            if kits_are_adopted or 'infertility' in cat.permanent_condition or (second_parent and 'infertility' in second_parent.permanent_condition):
    ...
    @staticmethod
    def get_kits(
        kits_amount, cat=None, other_cat=None, clan=game.clan, adoptive_parents=None, backkit=None
        ):
